  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/users/create"><i class="fa fa-users"></i> <span>Criar usuários</span></a></li>
        <li><a href="/admin/categories"><i class="fa fa-users"></i> <span>Categorias</span></a></li>
        <li><a href="/admin/categories/create"><i class="fa fa-users"></i> <span>Criar Categorias</span></a></li>
        <li class="treeview">
